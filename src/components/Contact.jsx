const socialLinks = [
  {
    href: "https://github.com/havoczic05",
    icon: (
      <svg
        width="32"
        height="32"
  ...
  {
    href: "https://www.linkedin.com/in/hugogsalazar/",
    icon: (
      <svg
        width="32"
        height="32"
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[35ch] reveal-up">
            I bring the perfect mix of foundational skills and a commitment to
            achieve goals.
          </p>
        ...
        <form
          action="https://getform.io/f/bdryejmb"
          method="POST"
